...
print(f"✅ Bot ready! Monitoring GAINZ / WCRO pair on VVS")
...
async def on_ready():
    ...
    if channel:
        await channel.send("🚀 **GAINZ Trade Bot is now online!** Monitoring buys & sells on VVS (GAINZ/WCRO)")
    ...
    while True:
        try:
            for event in swap_filter.get_new_entries():
                ...
                # Create nice embed with chart link
                embed = discord.Embed(
                ...
                embed.set_footer(text="VVS Finance • Real-time alerts • Monkey Muscle 🦧")
